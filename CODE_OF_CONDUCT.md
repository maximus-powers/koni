...
is officially representing the community in public spaces. Examples of
representing the community include using an official email address, posting
through an official social media account, or acting as an appointed
representative at an online or offline event.

## Enforcement

Abusive, harassing, or otherwise unacceptable behavior may be reported
privately to the maintainers through a
[private GitHub report](https://github.com/maximus-powers/koni/security/advisories/new).
